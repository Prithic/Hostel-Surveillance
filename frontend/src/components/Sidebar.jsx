      ...
      <div className="flex h-full w-[272px] flex-col gap-3 p-3">
        <div className="liquid-glass relative overflow-hidden rounded-3xl px-4 py-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <span className="font-display block text-lg font-bold leading-none tracking-tight text-white">NestOS</span>
              <span className="text-[11px] font-medium text-white/45">Hostel OS</span>
            </div>
          </div>
        </div>
